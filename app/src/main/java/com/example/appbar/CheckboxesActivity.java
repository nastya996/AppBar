        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String userInputData =
                        getString(R.string.input_money) + ": " + mInputMoney.getText().toString() + "\n" +
                                getString(R.string.payment_info) + ": " + mInputInfo.getText().toString() + "\n";

                if (mBankCardChkBx.isChecked()) {
                    userInputData += getString(R.string.bank_card);
                }
                if (mMobilePhoneChkBx.isChecked()) {
                    userInputData += getString(R.string.mobile_phone);
                }
                if (mCashAddressChkBx.isChecked()) {
                    userInputData += getString(R.string.cash);
                }

                Toast.makeText(CheckboxesActivity.this, userInputData, Toast.LENGTH_LONG).show();
            }
        });
    }
